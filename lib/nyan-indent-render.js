...
const isLineUsingTabulations = (textEditor, { line }) => {
...
const paintTextEditorLine = (textEditor, {
  ...
  const usedTabLength = isLineUsingTabulations(textEditor, { line })
    ? 1
    : tabLength;

  const indentationLimit = lineIndentation * usedTabLength;
